<section>
    ...
    <form id="form" class="ajax-form" action="/<?= $lang ?>/api/signin" method="POST" data-redirect="<?= $loginUrl ?>">
        <input type="hidden" name="form_type" value="signin">
        <div>
            <label for="user"><?= $user ?></label>
            <input type="text" name="user" id="user" autocomplete="off" placeholder="<?= $userHold ?>">
